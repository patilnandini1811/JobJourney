...
password: "",
  ...
  return (
    <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        ...
        />
          <h2 className="mt-10 text-center text-3xl md:text-4xl font-bold tracking-tight text-blue-500">Sign in to your account</h2>
        </div>
  ...
  Password
                ...
                <div className="text-sm">
                  <a href="#" className="block text-lg md:text-xl font-semibold text-indigo-400 hover:text-indigo-300">
                    Forgot password?
                  </a>
                </div>
              </div>
